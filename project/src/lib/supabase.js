...
function resolveAdminEmail() {
  const configuredEmail = import.meta.env.VITE_ADMIN_EMAIL && String(import.meta.env.VITE_ADMIN_EMAIL).trim().toLowerCase();
...
export async function verifyFiftyStoreDatabase() {
